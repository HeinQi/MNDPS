...
//甘肃天成食品有限公司
public class LZHualianDataPullService implements RetailerDataPullService {
	...
	public String login(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpPost httppost = new HttpPost("http://lanzhou.beijing-hualian.com/lzweb/checksuppllogin.asp");
		...
		// forward
		HttpGet httpGet = new HttpGet("http://lanzhou.beijing-hualian.com/lzweb/suppl_select.asp");
	...
	public void getSales(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpGet salesHttpGet = new HttpGet("http://lanzhou.beijing-hualian.com/lzweb/suppl_select.asp?action=sale");
	...
	private void getSalesByStore(CloseableHttpClient httpClient, User user, String storeId, List<SalesTO> salesList, String searchDate)
		...
		HttpEntity loginEntity = new UrlEncodedFormEntity(formParams, "UTF-8");
		HttpPost httppost = new HttpPost("http://lanzhou.beijing-hualian.com/lzweb/suppl_select.asp?action=salesel");
		httppost.setEntity(loginEntity);
		CloseableHttpResponse loginResponse = httpClient.execute(httppost);
