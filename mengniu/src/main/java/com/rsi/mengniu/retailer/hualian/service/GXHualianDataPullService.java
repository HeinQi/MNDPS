...
//广西南宁伊品蓝商贸有限公司
public class GXHualianDataPullService implements RetailerDataPullService {
...
public List<String> getDistrict(CloseableHttpClient httpClient) throws Exception {
	...
	HttpGet httpGet = new HttpGet("http://guangxi.beijing-hualian.com/supplier/index.asp");
	...
	public String login(CloseableHttpClient httpClient, User user,String district,HashMap<String, Object> contextMap) throws Exception {
		...
		HttpPost httppost = new HttpPost("http://guangxi.beijing-hualian.com/supplier/checksuppllogin.asp");
		...
		// forward
		HttpGet httpGet = new HttpGet("http://guangxi.beijing-hualian.com/supplier/suppl_select.asp");
	...
	public void getSales(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpGet salesHttpGet = new HttpGet("http://guangxi.beijing-hualian.com/supplier/suppl_select.asp?action=sale");
	...
	private void getSalesByStore(CloseableHttpClient httpClient, User user, String storeId, List<SalesTO> salesList, String searchDate)
		...
		HttpEntity loginEntity = new UrlEncodedFormEntity(formParams, "UTF-8");
		HttpPost httppost = new HttpPost("http://guangxi.beijing-hualian.com/supplier/suppl_select.asp?action=salesel");
		httppost.setEntity(loginEntity);
		CloseableHttpResponse loginResponse = httpClient.execute(httppost);
