...
//贵阳蒙牛乳业贸易有限公司
//贵阳农汇食品营销有限公司
public class GYHualianDataPullService implements RetailerDataPullService {
	...
	public String login(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpPost httppost = new HttpPost("http://guiyang.beijing-hualian.com/checksuppllogin.asp");
		...
		// forward
		HttpGet httpGet = new HttpGet("http://guiyang.beijing-hualian.com/suppl_select.asp");
	...
	public void getSales(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpGet salesHttpGet = new HttpGet("http://guiyang.beijing-hualian.com/suppl_select.asp?action=sale");
	...
	private void getSalesByStore(CloseableHttpClient httpClient, User user, String storeId, List<SalesTO> salesList, String searchDate)
		...
		HttpEntity loginEntity = new UrlEncodedFormEntity(formParams, "UTF-8");
		HttpPost httppost = new HttpPost("http://guiyang.beijing-hualian.com/suppl_select.asp?action=salesel");
		httppost.setEntity(loginEntity);
		CloseableHttpResponse loginResponse = httpClient.execute(httppost);
