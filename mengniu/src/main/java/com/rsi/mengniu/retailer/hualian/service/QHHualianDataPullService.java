...
//宝鸡市鹏瑞商贸有限公司
//青海荣天祥商贸有限公司
public class QHHualianDataPullService implements RetailerDataPullService {
	private static Log log = LogFactory.getLog(QHHualianDataPullService.class);
	...
	public String login(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpPost httppost = new HttpPost("http://qinghaihuayuan.beijing-hualian.com/checksuppllogin.asp");
		...
		// forward
		HttpGet httpGet = new HttpGet("http://qinghaihuayuan.beijing-hualian.com/suppl_select.asp");
	...
	public void getSales(CloseableHttpClient httpClient, User user) throws Exception {
		...
		HttpGet salesHttpGet = new HttpGet("http://qinghaihuayuan.beijing-hualian.com/suppl_select.asp?action=sale");
	...
	private void getSalesByStore(CloseableHttpClient httpClient, User user, String storeId, List<SalesTO> salesList, String searchDate)
		...
		HttpEntity loginEntity = new UrlEncodedFormEntity(formParams, "UTF-8");
		HttpPost httppost = new HttpPost("http://qinghaihuayuan.beijing-hualian.com/suppl_select.asp?action=salesel");
		httppost.setEntity(loginEntity);
		CloseableHttpResponse loginResponse = httpClient.execute(httppost);
